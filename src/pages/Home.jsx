          ...
          <div className="min-h-screen flex items-center bg-gradient-to-b to-indigo-500/75 from-black/75 p-4 backdrop-blur-sm mx-auto">
            <div className="max-w-screen-lg mx-auto">
              ...
              <p className="drop-shadow-sm">
                ...
                meatballs are juicy and tender, and the spaghetti is cooked to a
                perfect al dente texture. The tomato sauce is rich and
                flavorful, with just the right amount of acidity and sweetness
                to complement the meatballs. The combination of fresh herbs and
                Parmesan cheese adds depth and complexity to the dish. Finally,
                the dish is garnished with a sprinkle of fresh parsley and a
                drizzle of extra-virgin olive oil for added freshness and
                richness. All these elements come together to create a delicious
                and satisfying meal that is sure to please any pasta lover.
              </p>
            </div>
          </div>
        </div>
