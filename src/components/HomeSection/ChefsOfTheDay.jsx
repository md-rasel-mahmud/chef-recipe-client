...
const ChefsOfTheDay = ({ chefs }) => {
  ...
  return (
    <div className="bg-base-200">
      <section className=" max-w-screen-lg mx-auto rounded-lg p-5">
        <div className="container mx-auto">
          <div className="text-center">
            <h2 className="text-center text-3xl text-accent underline underline-offset-8 mt-8">
              Chefs of the Day
            </h2>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2 items-center min-h-[70vh]">
              ...
              <div className="bg-base-100 rounded-lg shadow-lg p-6 flex gap-2 flex-col md:flex-row items-center relative">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2 flex gap-2 items-center">
                    <FaUserCircle />
                    <span className="uppercase text-accent">{chef.name}</span>
                  </h4>
